...
INSERT INTO todo(title, personName, sequence) VALUES('자바스크립트공부하기', '홍길동', 1);
INSERT INTO todo(title, personName, sequence) VALUES('리포트 제출하기', '홍길동', 2);
INSERT INTO todo(title, personName, sequence) VALUES('리포트 제출하기2', '홍길동', 3);
