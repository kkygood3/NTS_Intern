...
<body>
	...
	<li class="item" style="background-image: url({promotionImageUrl});">
		<a href="detailProduct?displayInfoId={displayInfoId}"> <span class="img_btm_border"></span> <span class="img_right_border"></span> <span class="img_bg_gra"></span>
			<div class="event_txt">
	...
	<script type="rv-template" id="productItem">
		<li class="item">
			<a href="detailProduct?displayInfoId={displayInfoId}" class="item_book">
