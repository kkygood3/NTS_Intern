...
<body>
                ...
                <div class="section_visual">
                    <header>
                        ...
                        <c:choose>
							...
							<c:otherwise>
								<a href="../myReservation?userEmail=${sessionScope.userEmail }" class="btn_my"> <span title="내예약" class="viewReservation">${sessionScope.userEmail }</span> </a>
							</c:otherwise>
						</c:choose>
                    </header>
                            ...
                            <div class="store_info">
                                ...
                                <div class="lst_store_info_wrap">
                                    <ul class="lst_store_info">
                                        <li class="item"> <span class="item_lt"> <i class="fn fn-call2"></i> <span class="sr_only">전화번호</span> </span> <span class="item_rt"> <a href="tel:02-548-0597" class="store_tel"></a></span> </li>
                                    </ul>
                                </div>
                            </div>
    ...
    <script type=rv-template id="imageItem">
		<li class="item product_image" style="width: 414px;"> <img alt="{{description}}" class="img_thumb" src="{{imageUrl}}"> <span class="img_bg"></span>
		...
		<li class="list_item">
			<div>
				<div class="review_area">
					...
					<p class="review">{{coment}}</p>
				</div>
				<div class="info_area">
					<div class="review_info"> <span class="grade">{{score}}</span> <span class="name">{{name}}</span> <span class="date">{{date}}</span> </div>
				</div>
			</div>
		</li>
	</script>
