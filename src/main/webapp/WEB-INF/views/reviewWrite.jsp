...
<body>
		...
		<div class="ct">
			<div class="ct_wrap">
				<div class="top_title review_header">
					...
					<h2><span class="title">${ reservationResponse.reservationInfo.displayInfo.productDescription }</span></h2>
				</div>
				...
				<div class="review_contents write">
					...
					<textarea name="comment" cols="30" rows="10" class="review_textarea" maxlength="400"></textarea>
				</div>
				<!-- //리뷰 입력 -->
				...
				<div class="review_write_footer_wrap">
					<div class="review_write_footer">
						...
						<input type="file" name="file" class="hidden_input" id="reviewImageFile" accept="image/*" multiple>
				...
				<div class="box_bk_btn">
					<button class="bk_btn" data-reservation-info-id="${ reservationResponse.reservationInfo.reservationInfoId }" data-product-id="${ reservationResponse.reservationInfo.displayInfo.productId }"><span class="btn_txt">리뷰 등록</span></button>
				</div>
				<!-- //리뷰 등록 -->
			</div>
		</div>
	...
	<script src="/resources/javascript/reviewWrite.js"></script>
</body>
</html>