		...
		<div class="ct">
			<div class="ct_wrap">
				...
				<div class="review_contents write">
					...
					<textarea cols="30" rows="10" class="review_textarea" style="resize: vertical;"></textarea>
				</div>
				<!-- //리뷰 입력 -->
				...
				<div class="review_write_footer_wrap">
					<div class="review_write_footer">
						<label class="btn_upload" for="reviewImageFileOpenInput">
							...
							<span class="text_add_photo">사진 등록</span>
						</label>
						<input type="file" class="hidden_input" id="reviewImageFileOpenInput" accept="image/png, image/jpeg" multiple>
