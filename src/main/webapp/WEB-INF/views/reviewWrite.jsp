...
<body>
	<div id="container">
		...
		<div class="ct" data-productid="${reservation.productId}" data-reservationinfoid="${reservation.reservationInfoId}">
			<div class="ct_wrap">
				<div class="top_title review_header">
					<a href="./myreservation.html" class="btn_back" title="이전 화면으로 이동"> <i class="fn fn-backward1"></i> </a>
					<h2><span class="title">${reservation.description}</span></h2>
				</div>
				<!-- 리뷰 별점 -->
				<div class="write_act">
					...
					<div class="review_rating rating_point">
						<div class="rating">
							...
							<input type="checkbox" name="rating2" value="1" class="rating_rdo checked" title="1점">
							...
							<span class="star_rank gray_star">1</span>
						</div>
					</div>
				</div>
				<!-- //리뷰 별점 -->
				...
				<div class="review_write_footer_wrap">
					...
					<div class="review_photos review_photos_write">
						<div class="item_preview_thumbs">
							<ul class="lst_thumb picture_ul">
								<script id="review_picture_template" type="text/x-handlebars-template">
								
								<li class="item">
									<a class="anchor remove_picture">
										<span class="spr_book ico_del">삭제</span>
									</a>
									<img src="{{imageUri}}" width="130" alt="" class="item_thumb">
				...
				<div class="box_bk_btn">
					<button class="bk_btn review_regist_button"><span class="btn_txt">리뷰 등록</span></button>
				</div>
				<!-- //리뷰 등록 -->
			</div>
		</div>
	...
	<script src="/static/js/review/write/reviewWriteConvert.js"></script>
</body>
</html>