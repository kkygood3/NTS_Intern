	...
	<div id="container">
		...
		<div class="ct main">
			<div>
				...
				<div class="section_btn"> <button id="reservation" type="button" class="bk_btn" data-id="${ displayInfoId }"> <i class="fn fn-nbooking-calender2"></i> <span>예매하기</span> </button> </div>
				<div class="section_review_list">
					...
					<a class="btn_review_more" href="/detailComment?displayInfoId=${ displayInfoId }"> <span>예매자 한줄평 더보기</span> <i class="fn fn-forward1"></i> </a>
				</div>
