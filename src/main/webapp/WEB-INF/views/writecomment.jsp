...
<body>
		...
		<div class="header fade">
			<header class="header_tit">
				<h1 class="logo">
				  ...
				  <a href="/my-reservation" class="btn_my"> <span title="예약확인">예약확인</span> </a>
			</header>
		</div>
		<div class="ct" id="reservation_id" data-reservation-id="${reservationId}">
			<div class="ct_wrap">
				<div class="top_title review_header">
					<a href="/my-reservation" class="btn_back" title="이전 화면으로 이동"> <i class="fn fn-backward1"></i> </a>
				...
				<div class="write_act">
					...
					<div class="review_rating rating_point">
						<div id="rating" class="rating">
							...
							<input type="checkbox" name="rating2" value="1" class="rating_rdo" title="1점" checked>
				...
				<div class="review_contents write">
					...
					<a id="review_write_info" href="#" class="review_write_info">
						<span class="middot">
					...
					<textarea id="review_write" cols="30" rows="10" class="review_textarea" maxlength="400"></textarea>
				</div>
				<!-- //리뷰 입력 -->
				...
				<div class="review_write_footer_wrap">
					<div class="review_write_footer">
						<label class="btn_upload" for="review_image_open">
							<i class="fn fn-image1" aria-hidden="true"></i>
							<span class="text_add_photo">사진 추가</span>
						</label>
						<input type="file" class="hidden_input" id="review_image_open" accept="image/*" multiple>
						<div class="guide_review">
							<span id="word_count">0</span>/400
							<span>(최소5자이상)</span>
						</div>
					</div>
					...
					<div class="review_photos review_photos_write">
						<div class="item_preview_thumbs">
							<ul id="review_image_list" class="lst_thumb">
				...
				<div class="box_bk_btn">
					<button id="btn_submit" class="bk_btn"><span class="btn_txt">리뷰 등록</span></button>
				</div>
				<!-- //리뷰 등록 -->
			</div>
		</div>
	...
	<script type="text/template" class="template" data-parse-name="ImageView">
		<li class="item" data-index="{{index}}">
			<a href="#" class="anchor delete">
				<span class="spr_book ico_del">삭제</span>
			</a>
			<img src="{{imgUrl}}" width="130" alt="" class="item_thumb">
