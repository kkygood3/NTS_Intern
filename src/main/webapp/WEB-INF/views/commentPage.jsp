...
<body>
	<div id="container" data-product-id=${reservation.displayInfo.productId } data-reservation-id=${reservation.reservationInfoId }>
		<div class="header fade">
			<header class="header_tit">
				<h1 class="logo">
				  ...
				  <a href="./myReservation?userEmail=${sessionScope.userEmail }" class="btn_my"> 
		...
		<div class="ct">
			<div class="ct_wrap">
				<div class="top_title review_header">
					...
					<h2><span class="title">${reservation.displayInfo.productDescription }</span></h2>
				</div>
				<!-- 리뷰 별점 -->
				<div class="write_act">
