					...
					<form name="confirm_form" class="ng-pristine ng-valid" id="form1"
						...
						<div class="login_form">
							<label class="label_form" for="resrv_id"
								...
								id="resrv_id" name="userEmail" aria-invalid="false"
								placeholder="crong@naver.com" title="예매자 이메일" pattern="^[a-zA-Z0-9]{1,20}@[a-zA-Z0-9]{1,20}\.[a-zA-Z]{1,6}\.[a-zA-Z]{1,6}$|^[a-zA-Z0-9]{1,20}@[a-zA-Z0-9]{1,20}\.[a-zA-Z]{1,6}$" requried>
						</div>
