...
<body>
					...
					<div class="card_detail">
						...
						<ul class="detail">
							<li class="item"><span class="item_tit">일정</span> <em
								class="item_dsc"> {{rsvDateSplit reservationDate}} </em></li>
							<li class="item"><span class="item_tit">내역</span> <em
								class="item_dsc"> 내역이 없습니다. </em></li>
							<li class="item"><span class="item_tit">장소</span> <em
								class="item_dsc"> <p>{{displayInfo.placeName}} <br> {{displayInfo.placeLot}}</p> </em></li>
							<li class="item"><span class="item_tit">업체</span> <em
								class="item_dsc"> {{displayInfo.placeName}} </em></li>
						</ul>
	...
	<script type="text/javascript" src="/reservation/resources/js/pages/pageUtils/myreservationPage_utils.js"></script>
	<script type="text/javascript" src="/reservation/resources/js/pages/myreservationPage_script.js"></script>
</body>
