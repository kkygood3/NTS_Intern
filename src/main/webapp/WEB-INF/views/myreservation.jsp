	...
	<div id="container">
		<div class="header">
			<header class="header_tit">
				...
				<a href="#" class="btn_my"> <span title="내예약" class="viewReservation">${sessionScope.reservationEmail}</span> </a>
			</header>
		</div>
		<hr>
		<div class="ct">
			<div class="section_my" data-reservationemail="${sessionScope.reservationEmail}">
				<!-- 예약 현황 -->
				...
				<div class="wrap_mylist">
					<ul class="list_cards" ng-if="bookedLists.length > 0">
						...
						<li class="card confirmed">
							...
							<script id="reservation_template" type="text/x-handlebars-template">
										...
										<div class="card_detail">
											...
											<ul class="detail">
												<li class="item">
													...
													<em class="item_dsc reservation_date">
											...
											<div class="booking_cancel">
												<button class="btn cancel_button"><span>취소</span></button>
											</div>
										</div>
									</div>
									<div class="right"></div>
							...
							<li class="card used cancel">
								...
								<script id="reservation_cancel_template" type="text/x-handlebars-template">
								<article class="card_item">
		...
		<div class="popup_booking_wrapper" style="display:none;">
			...
			<div class="popup_booking refund">
				<h1 class="pop_tit">
					...
					<small class="sm reservation_date"></small>
				</h1>
				<div class="nomember_alert">
					<p>취소하시겠습니까?</p>
				</div>
				<div class="pop_bottom_btnarea">
					<div class="btn_gray cancel_no">
						<a class="btn_bottom"><span>아니오</span></a>
					</div>
					<div class="btn_green cancel_yes">
		...
		<!--// 취소 팝업 -->
		<script src="/static/js/reservation/reservationConvert.js"></script>
	</body>
