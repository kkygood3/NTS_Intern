    ...
    <div id="container">
        ...
        <div class="event">
                    ...
                    <div class="container_visual">
                        ...
                        <div>
                            <div class="container_visual">
                                ...
                                <ul id="promotion_list" class="visual_img">
                                </ul>
                            </div>
            ...
            <div class="section_event_tab">
                <ul id="category_list" class="event_tab_lst tab_lst_min">
            ...
            <div class="section_event_lst">
                <p class="event_lst_txt">바로 예매 가능한 행사가 <span class="pink"><span id="totalCount">10</span>개</span> 있습니다</p>
