		...
		<app>
			...
			<div class="_view_content" ui-view="content" id="container" >
				<booked-confirm>
					<div class="booking_login">
						...
						<!---->
						<div >
							<form name="confirm_form" class="ng-pristine ng-valid" id="form1" action="lookUpReservation" method="post">
			...
			<footer  aria-hidden="false">
				<div id="footer" class="footer"  >
					...
					<dl class="box_vcard">
						<dt class="tit_dt"> <a href="#" class="lnk_naver"	title="펼쳐보기"> <span translate="CM-NAVER_INC">(주)네이버 사업자정보</span> <i class="fn fn-down2" aria-hidden="true" ></i> </a> </dt>
						<!----> 
					</dl>
					<ul class="lst_link">
						<li class="item"> <a class="anchor" ui-sref="policy" href="#"> <span translate="CM-TERMS">이용약관</span> </a> </li>
						<li class="item"> <a class="anchor" href="#"> <strong class="policy_em" translate="CM-PRIVACY_POLICY">개인정보처리방침</strong> </a> </li>
						<li class="item"> <a href="#" class="anchor" > <span translate="CM-CUSTOMER_CENTER_NBOOKING">네이버 예약 고객센터</span> </a> </li>
					</ul>
				...
				<div class="sel_box_on">
					...
					<div class="select_layer">
						<div class="select_tit">
							...
							<a href="/"  class="close"  title="MBK-selectBox-CLOSE"> <i class="fn fn-close" aria-hidden="true"></i> </a> 
						</div>
						<ul class="lst_select">
							<li class="item" > <a href="/" class="anchor" > <span>한국어</span> </a> </li>
							<li class="item" > <a href="/" class="anchor" > <span>English</span> </a> </li>
						</ul>
					</div>
				</div>
			</translater-modal>
