...
<html lang="ko" class="no-js" >
   <head>
      ...
      <link rel="stylesheet" href="/static/css/bookinglogin.css">
   </head>
   <body class="biz  ko" >
                  ...
                  <div >
                     <form name="confirm_form" class="ng-pristine ng-valid" id="form1">
                        ...
                        <div class="login_form"> 
                           ...
                           <input type="text" class="login_input ng-pristine ng-untouched ng-valid ng-empty reservation_email" id="resrv_id" name="resrv_email" aria-invalid="false" placeholder="crong@naver.com" title="예매자이메일">  </div>
      ...
      <script src="/static/js/login/loginConvert.js"></script>
   </body>
</html>