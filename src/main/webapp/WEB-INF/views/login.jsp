...
<body class="biz  ko">
	...
	<a href="/" class="top_info_close" data-tst_alt_close="0"> <i
		class="fn fn-close" aria-hidden="true"></i> <span class="sr_only"
	...
	<div class="_view_content" ui-view="content" id="container">
		...
		<div class="booking_login">
			<h1 class="login_header">
				<a href="/" class="nbooking_logo spr_bi txt_logo"> <span
				...
				<form name="confirm_form" class="ng-pristine ng-valid" id="form1"
					...
					<div class="login_form">
						<label class="label_form" for="resrv_id"
							...
							id="resrv_id" name="reservationEmail" aria-invalid="false"
	...
	<footer aria-hidden="false">
		...
		<div id="footer" class="footer">
			<ul class="lst_nav">
				...
				<!---->
				<li class="lnk_item"><a href="http://m.naver.com/services.html"
					class="anchor"> <span translate="CM-WHOLE_SERVICE">전체서비스</span>
				</a></li>
			</ul>
			...
			<dl class="box_vcard">
				<dt class="tit_dt">
					<a href="https://m.booking.naver.com/#" class="lnk_naver"
						title="펼쳐보기"> <span translate="CM-NAVER_INC">(주)네이버
			...
			<ul class="lst_link">
				<li class="item"><a class="anchor" ui-sref="policy"
					href="https://m.booking.naver.com/policy"> <span
						translate="CM-TERMS">이용약관</span>
				</a></li>
				<li class="item"><a class="anchor"
					href="https://nid.naver.com/mobile/user/help/termAgree.nhn?m=viewTermAgree3">
						<strong class="policy_em" translate="CM-PRIVACY_POLICY">개인정보처리방침</strong>
				</a></li>
				<li class="item"><a href="https://m.booking.naver.com/#"
					class="anchor"> <span translate="CM-CUSTOMER_CENTER_NBOOKING">네이버
							예약 고객센터</span>
				</a></li>
			</ul>
		...
		<!---->
		<!---->
	</footer> <dialog-alert> <!----> </dialog-alert> <translater-modal
		style="display: none;">
	<div class="sel_box_on">
		...
		<div class="select_layer">
			<div class="select_tit">
				...
				<a href="https://m.booking.naver.com/#" class="close"
					title="MBK-selectBox-CLOSE"> <i class="fn fn-close"
					aria-hidden="true"></i>
				</a>
			</div>
			<ul class="lst_select">
				<li class="item"><a href="https://m.booking.naver.com/#"
					class="anchor"> <span>한국어</span>
				</a></li>
				<li class="item"><a href="https://m.booking.naver.com/#"
