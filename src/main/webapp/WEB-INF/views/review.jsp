...
<body>
			...
			<div>
				<div class="review_area {{#unless commentImages.length}}no_img{{/unless}}">
					<div class="thumb_area">
						{{#if commentImages}}
						<a href="/reservation/api/commentimage/{{commentImageId this}}" class="thumb" title="이미지 크게 보기"> 
	...
	<script type="text/javascript" src="/reservation/resources/js/pages/reviewPage_script.js"></script>
</body>
</html>