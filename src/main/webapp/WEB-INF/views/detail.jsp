...
<body>
	...
	<script type="rv-template" id="bannerImage">
		<li class="item" style="width: 414px;"> <img alt="{{productDescription}}" class="img_thumb" src="{{saveFileName}}"> <span class="img_bg"></span>
			...
			<div>
				...
				<div class="info_area">
					<div class="review_info">
						<span class="grade">{{score}}.0</span> <span class="name">{{reservationName}}</span> <span class="date">{{reservationDate}} 방문</span> 
					</div>
				</div>
			</div>
		</li>
