			...
			<div>
				<div class="review_area">
					...
					<div class="thumb_area">
						<a href="#" class="thumb" title="이미지 크게 보기"> <img width="90" height="90" class="img_vertical_top" src="/download/{{reservationUserCommentImageId}}" alt=""> </a> <span class="img_count" style="display:none;">1</span>												
					</div>
					{{/if}}
