...
<body>
		...
		<div class="ct main">
			<div>
				<div class="section_visual">
					...
					<div class="pagination" id="product_image_counts">
						<div class="bg_pagination"></div>
						<div class="figure_pagination">
							<span class="num" id="product_image_count"></span>
							 <span class="num off">
							/ <span id = "total_product_image_count"></span>
							</span>
						</div>
					</div>
					<div class="group_visual">
						<div>
							<div class="container_visual" style="width: 414px;">
								<ul class="visual_img detail_swipe" id="background_image_ul">
				...
				<div class="section_store_details">
					...
					<div class="store_details close3" id="product_content_div">
						<p class="dsc" id="product_content_paragraph">
							{{#product_content content}}
							{{/product_content}}
						</p>
					</div>
                    <!-- [D] 토글 상황에 따라 bk_more에 display:none 추가 -->
					<a href="script:void(0);" class="bk_more _open" id="more_button_open"> 
						<span class="bk_more_txt">펼쳐보기</span>
						<i class="fn fn-down2"></i>
					</a>
					<a href="script:void(0);" class="bk_more _close" id="more_button_close" style="display: none;"> 
				...
				<div class="section_btn">
					<button type="button" class="bk_btn" id="reservation_button">
				...
				<div class="section_review_list">
					...
					<a class="btn_review_more" href="review?id=" id = "review_more_button">
				...
				<div class="section_info_tab">
					...
					<ul class="info_tab_lst">
						<li class="item active _detail">
							<a href="javascript:void(0);"class="anchor active" id="detail_info">
								<span>상세정보</span>
							</a>
						</li>
						<li class="item _path">
							<a href="javascript:void(0);" class="anchor" id="path">
								<span>오시는길</span>
							</a>
						</li>
					</ul>
                    <!-- [D] 상세정보 외 다른 탭 선택 시 detail_area_wrap에 hide 추가 -->
					<div class="detail_area_wrap" id="detail_info_wrap">
						
					</div>
                    <!-- [D] 오시는길 외 다른 탭 선택 시 detail_location에 hide 추가 -->
					<div class="detail_location hide" id="path_wrap">
	...
	<script type="rv-template" id="detail_info_template">
	...
	<script type="rv-template" id="path_template">
				...
				<div class="lst_store_info_wrap">
					<ul class="lst_store_info">
						<li class="item">
							...
							<span class="item_rt">
								<a href="tel:{{tel}}" class="store_tel">{{tel}}</a>
							</span>
						</li>
					</ul>
				</div>
