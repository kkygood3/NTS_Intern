            ...
            <div>
                <div class="section_visual">
                    <header>
                        ...
                        <a href="/reservations" class="btn_my"> <span class="viewReservation" title="예약확인">예약확인</span> </a>
                    </header>
                    <div class="pagination">
                        <div class="bg_pagination"></div>
                        <div class="figure_pagination">
                            <span class="num product_number">1</span>
                            <span class="num off">/ <span id="product_image_max"></span></span>
                        </div>
                    </div>
                            ...
                            <div class="container_visual" style="width: 414px;">
                                <ul class="visual_img ct detail_swipe product_images_ul">
                                	<script id="product_images_template" type="text/x-handlebars-template">
                                		{{#each productImages}}
											<li class="item single_slide" style="width: 414px;" data-index="{{@index}}"> <img alt="" class="img_thumb" src="/static/{{saveFileName}}"> <span class="img_bg"><span class="product_title"></span></span>
                ...
                <div class="section_store_details display_info_detail" data-displayinfoid="${displayInfoId}">
                ...
                <div class="section_event">
                    <div class="event_info_box">
                        ...
                        <div class="event_info">
	                        <script id="product_event_template" type="text/x-handlebars-template">
                ...
                <div class="section_btn"> <button type="button" class="bk_btn reserve_button"> <i class="fn fn-nbooking-calender2"></i> <span>예매하기</span> </button> </div>
                    ...
                    <div class="review_box">
                        ...
                        <div class="short_review_area">
                            <div class="grade_area">
                                ...
                                <span class="graph_mask"> <em class="graph_value" id="comment_graph_star" style="width: 84%;"></em> </span>
                                <strong class="text_value"> <span id="comment_average"></span> <em class="total">5.0</em> </strong>
                                <span class="join_count"><em class="green"><span id="comment_count"></span>건</em> 등록</span>
                            </div>
                                    	...
                                    	<div>
                                        	...
                                        	<div class="review_area">
                                            	<div class="thumb_area">
                                                	<a href="#" class="thumb" title="이미지 크게 보기"> <img width="90" height="90" class="img_vertical_top" src="/api/comments/{{commentId}}/commentId" alt="리뷰이미지"> </a> <span class="img_count" style="display:none;">1</span>                                                </div>
                                            		<h4 class="resoc_name"></h4>
                                            		<p class="review">{{comment}}</p>
                                        		</div>
                                        		<div class="info_area">
                                            		<div class="review_info"> <span class="grade">{{score}}.0</span> <span class="name">{{userEmailEncrypt reservationEmail}}</span> <span class="date">{{reservationDateYYYYMMDD reservationDate}} 방문</span> </div>
                                        		</div>
                                    		</div>
											{{else}}
                ...
                <div class="section_info_tab">
                    ...
                    <div class="detail_location hide">
                        <div class="box_store_info no_topline product_location">
                        	<script id="detail_location_template" type="text/x-handlebars-template">
                            <a href="#" class="store_location" title="지도웹으로 연결">
                                <img class="store_map img_thumb" alt="map" src="/static/{{saveFileName}}">
