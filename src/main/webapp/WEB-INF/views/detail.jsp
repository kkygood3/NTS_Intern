...
<body>
                    ...
                    <header>
                        ...
                        <c:choose>
		                	<c:when test="${email ne null}">
		                		<a href="/my-reservation" class="btn_my"> <span class="viewReservation" title="로그인">${email}</span> </a>
		                	</c:when>
		                	<c:otherwise>
	...
	<script type="text/javascript" src="/resources/js/page/detail.js"></script>
