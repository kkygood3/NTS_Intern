...
<body>
	...
	<script type="text/javascript" src="resources/js/pages/pageUtils/reservePage_utils.js"></script>
	<script type="text/javascript" src="resources/js/pages/reservePage_script.js"></script>
</body>
</html>