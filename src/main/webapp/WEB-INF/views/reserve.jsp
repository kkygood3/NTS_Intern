...
<body>
	<div id="container">
		...
		<div class="ct">
			<div class="ct_wrap">
				<div class="top_title">
					<a href="/display/detail/${ displayResponse.displayInfo.displayInfoId }" class="btn_back" title="이전 화면으로 이동">
					...
					<div class="container_visual" style="width: 414px;">
						<ul class="visual_img">
							<li class="item" style="width: 414px;">
								<img alt="" class="img_thumb" src="/resources/img/${ displayResponse.productImages[0].saveFileName }">
				...
				<div class="section_booking_ticket">
					<div class="ticket_body">
						...
						<c:forEach var="price" items="${ displayResponse.productPrices }">
							<fmt:formatNumber var="calculatedPrice" value="${ price.price * (1 - (price.discountRate / 100)) }" type="number" pattern="#,###"/>
							<div class="qty">
								<div class="count_control">
									<div class="clearfix">
										<a class="btn_plus_minus spr_book2 ico_minus3 disabled" title="빼기"> </a>
										<input type="tel" class="count_control_input disabled" value="0" data-price="<fmt:formatNumber value="${ price.price * (1 - (price.discountRate / 100)) }" type="number" pattern="0"/>" data-priceId="${ price.productPriceId }" readonly title="수량">
							...
							<form class="form_horizontal" action="/api/reservations" method="POST">
								<div class="inline_form">
									...
									<div class="inline_control">
										<input type="text" name="reservationName" id="name" class="text" placeholder="네이버" maxlength="17">
									</div>
								</div>
								<div class="inline_form">
					...
					<div class="section_booking_agreement">
						...
						<div class="agreement">
							<span class="chk_txt_span">
								<i class="spr_book ico_arr_ipc2"></i> <span>개인정보 수집 및 이용 동의</span>
							</span> 
						...
						<!-- [D] 약관 보기 클릭 시 agreement에 open 클래스 추가 -->
						<div class="agreement">
							<span class="chk_txt_span"> <i class="spr_book ico_arr_ipc2"></i> <span>개인정보 제3자 제공 동의</span>
							</span> <a class="btn_agreement"> <span class="btn_text">보기</span> <i class="fn fn-down2"></i>
							</a>
							<div class="useragreement_details custom_details_wrap">
								<div class="custom_details">
									...
									<br> 4. 개인정보를 제공받는 자의 개인정보 보유 및 이용기간 : 개인정보 이용목적 달성 시 까지 보관합니다.<br>
									<br> 5. 동의 거부권 등에 대한 고지 : 정보주체는 개인정보 제공 동의를 거부할 권리가 있으나, 이 경우 상품 및 서비스 예약이 제한될 수 있습니다.<br>
								</div>
							</div>
						</div>
					</div>
	...
	<script src="/resources/javascript/reserve.js"></script>
</body>
</html>
