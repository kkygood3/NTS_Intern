...
<body>
    <div id="container">
        ...
        <div class="ct">
            <div class="ct_wrap" id="reservation_body">
                
                <div class="section_booking_ticket">
		   			<div class="ticket_body">
		        		<div class="qty" id="ticket_body">
                ...
                <div class="section_booking_form">
                    <div class="booking_form_wrap">
                        <div class="form_wrap">
                            ...
                            <form class="form_horizontal" action="/api/reservations" method="post" id="reservation_form">
                                ...
                                <div class="inline_form last"> 
                                    ...
                                    <div class="inline_control" id="reservation_detail_div">
                                        <p class="inline_txt selected">
								 			<span id="now_date"></span>, 총
								 			<span id="total_count">0</span>매
								 		</p>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="section_booking_agreement">
                        <div class="agreement all"> 
                        	...
                        	<label for="chk3" class="label chk_txt_label" id="agreement_check_button"> 
                        ...
                        <div class="agreement" id="agreement_collecting"> 
                        	<span class="chk_txt_span"> 
                        		<i class="spr_book ico_arr_ipc2"></i> 
                        		<span>개인정보 수집 및 이용 동의</span> 
                        	</span>
                            <a href="javascript:void(0)" class="btn_agreement" id="agreement_collecting_btn"> 
                        ...
                        <!-- [D] 약관 보기 클릭 시 agreement에 open 클래스 추가 -->
                        <div class="agreement" id="agreement_providing"> 
                        	<span class="chk_txt_span"> 
                        		<i class="spr_book ico_arr_ipc2"></i> 
                        		<span>개인정보 제3자 제공 동의</span> 
                        	</span>
                            <a href="javascript:void(0)" class="btn_agreement" id="agreement_providing_btn">
                            	 <span class="btn_text">보기</span> 
                            	 <i class="fn fn-down2"></i> 
                            </a>
                ...
                <div class="box_bk_btn">
                    ...
                    <div class="bk_btn_wrap disable"> 
                    	<button type="button" class="bk_btn" id="submit_button"> 
	...
	<script type="rv-template" id="reserve_display_info">
		<div class="top_title">
		    <a href="javascript:history.go(-1)" class="btn_back" title="이전 화면으로 이동"> 
		    	<i class="fn fn-backward1"></i>
		    </a>
		    <h2><span class="title">_{description}</span></h2>
		</div>
		<div class="group_visual">
		    <div class="container_visual" style="width: 414px;">
		        <ul class="visual_img">
		            <li class="item" style="width: 414px;">
					  <img alt="" class="img_thumb" src="_{productImageUrl}"> 
						<span class="img_bg"></span>
		                <div class="preview_txt">
		                    <h2 class="preview_txt_tit"></h2> 
		                    <em class="preview_txt_dsc">₩_{minPrice}~</em>
		                </div>
		            </li>
		        </ul>
		    </div>
	...
	<script type="rv-template" id="reserve_choose_tickets">
        ...
        <div class="qty_info_icon"> 
        	<strong class="product_amount"> 
        		<span>_{priceType}</span> 
        	</strong> 
        	<strong class="product_price"> 
        		<span class="price">_{price}</span> 
        		<span class="price">원</span>
        	</strong> 
        	<em class="product_dsc">_{discountedPrice}원 (_{discountRate}% 할인)</em> 
    ...
    <script type = "text/javascript" src="/js/mapper/reservationdisplayinfo-mapper.js" charset="utf-8"></script>
    <script type = "text/javascript" src="/js/reservation/reserve-events.js" charset="utf-8"></script>
    <script type = "text/javascript" src="/js/reservation/reserve.js" charset="utf-8"></script>
</body>
