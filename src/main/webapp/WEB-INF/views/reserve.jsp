...
<body>
    <div id="container">
        ...
        <div class="ct" id="display_info_id_div" data-displayinfoid="${displayInfoId}">
            <div class="ct_wrap">
                <div class="top_title">
                    <a href="/main" class="btn_back" title="이전 화면으로 이동"> <i class="fn fn-backward1"></i> </a>
                    <h2><span class="title"></span></h2>
                </div>
                <div class="group_visual">
                    <div class="container_visual" style="width: 414px;">
                        <ul class="visual_img">
                            <li class="item" style="width: 414px;"> <img alt="썸네일 이미지" class="img_thumb" id="img_th" src=""> <span class="img_bg"></span>
                                <div class="preview_txt">
                                    <h2 class="preview_txt_tit"></h2> <em class="preview_txt_dsc"></em> </div>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="section_store_details">
                    <div class="store_details">
                        <h3 class="in_tit"></h3>
                        <p class="dsc">
                           장소 :<span id="place_lot"></span>
                        </p>
                        <h3 class="in_tit">요금</h3>
                        <p class="dsc" id="product_prices">
                        </p>
                    </div>
                </div>
                <div class="section_booking_ticket">
                    <div class="ticket_body">
                    	<script id="product_ticket_template" type="text/x-handlebars-template">
                        <div class="qty">
                            <div class="count_control">
                                <!-- [D] 수량이 최소 값이 일때 ico_minus3, count_control_input에 disabled 각각 추가, 수량이 최대 값일 때는 ico_plus3에 disabled 추가 -->
                                <div class="clearfix">
                                    <a class="btn_plus_minus spr_book2 ico_minus3 disabled minus_button" title="빼기"> </a> <input type="tel" class="count_control_input disabled" value="0" readonly title="수량">
                            ...
                            <div class="qty_info_icon"> <strong class="product_amount"> <span>{{productPrice.priceTypeName}} 석</span> </strong> <strong class="product_price"> <span class="price">{{productPrice.price}}</span> <span class="price_type">원</span> </strong> <em class="product_dsc">{{productPrice.price}}원 ({{productPrice.discountRate}}% 할인가)</em> </div>
                        </div>
                       </div>
                       </script>
                </div>
                            ...
                            <form class="form_horizontal">
                                ...
                                <div class="inline_form last"> <label class="label" for="message">예매내용</label>
                                    <div class="inline_control">
                                        <p class="inline_txt selected">2017.2.17, 총 <span id="total_count">0</span>매</p>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="box_bk_btn">
                    ...
                    <div class="bk_btn_wrap disable"> <button type="button" class="bk_btn" id="reservation_button"> <i class="spr_book ico_naver_s"></i>  <span>예약하기</span> </button> </div>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="/static/js/reserve/reserveConvert.js"></script>
</body>
</html>
