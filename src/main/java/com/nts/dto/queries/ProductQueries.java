...
public class ProductQueries {
	public static final String SELECT_PRODUCTS = "SELECT id, category_id, description, content, event, create_date, modify_date FROM product ORDER BY id DESC limit :limit";
