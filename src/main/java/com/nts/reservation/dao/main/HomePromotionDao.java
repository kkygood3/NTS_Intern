...
public class HomePromotionDao {
	...
	public List<HomePromotion> selectPromotions(int pagingLimit) {
		...
		return jdbc.query(HomeResponseSqls.SELECT_PROMOTION, params, rowMapper);
	}
	...
	public int selectCount() {
		return jdbc.queryForObject(HomeResponseSqls.SELECT_PROMOTION_COUNT, Collections.emptyMap(), Integer.class);
	}
}
