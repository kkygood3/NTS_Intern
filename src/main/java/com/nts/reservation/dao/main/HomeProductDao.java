...
public class HomeProductDao {
	...
	public List<HomeProduct> selectPagingProducts(int start, int pagingLimit) {
		...
		return jdbc.query(HomeSqls.SELECT_PRODUCT_PAGE, params, rowMapper);
	}
	...
	public List<HomeProduct> selectPagingProductsByCategory(int categoryId, int start, int pagingLimit) {
		...
		params.put("start", start);
		params.put("pagingLimit", pagingLimit);
		return jdbc.query(HomeSqls.SELECT_PRODUCT_PAGE_BY_CATEGORY, params, rowMapper);
	}
	...
	public int selectCountByCategory(int categoryId) {
		Map<String, Integer> params = new HashMap<>();
		params.put("categoryId", categoryId);
		return jdbc.queryForObject(HomeSqls.SELECT_PRODUCT_COUNT_BY_CATEGORY, params, Integer.class);
	}
	...
	public int selectCount() {
		return jdbc.queryForObject(HomeSqls.SELECT_PRODUCT_COUNT, Collections.emptyMap(), Integer.class);
	}
}
