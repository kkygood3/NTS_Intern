...
public class ProductDaoSqls {
	...
	public static final String SELECT_PROMOTION_PRODUCT = "SELECT display.id AS display_info_id, product.id AS product_id, product.content AS product_content"
		+ ", product.description AS product_description, display.place_name AS place_name, file_info.save_file_name AS product_image_url"
		+ " FROM promotion INNER JOIN display_info AS display ON promotion.product_id = display.product_id INNER JOIN product ON product.id = promotion.product_id"
