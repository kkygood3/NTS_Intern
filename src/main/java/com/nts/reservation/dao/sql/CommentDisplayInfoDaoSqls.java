...
public class CommentDisplayInfoDaoSqls {
	public static final String SELECT_COMMENT_WITH_PAGING = "SELECT uc.comment, uc.score, concat(left(ri.reservation_email, 4), '****') AS reservation_email, ri.reservation_date, ifnull(fi.save_file_name, '') AS save_file_name " + 
