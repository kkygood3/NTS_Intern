...
public class ProductDaoSqls {
	...
	public static final String SELECT_COUNT_PRODUCT = "SELECT"
		+ " COUNT(display.id)"
		+ " FROM"
		+ " product"
		+ " INNER JOIN"
	...
	public static final String SELECT_COUNT_PRODUCT_BY_CATEGORY = "SELECT"
		+ " COUNT(display.id)"
		+ " FROM"
		+ " product"
		+ " INNER JOIN"
	...
	public static final String SELECT_PROMOTION_PRODUCT = "SELECT " + PRODUCT_COLUMNS
		...
		+ " display_info AS display"
		+ " ON"
		+ " promotion.product_id = display.product_id"
		+ " INNER JOIN"
		+ " product"
		+ " ON"
		...
		+ " product_image"
		+ " ON"
		+ " product_image.product_id = promotion.product_id"
		+ " AND"
		+ " product_image.type = 'th'"
		+ " INNER JOIN"
		+ " file_info AS file"
		+ " ON"
		+ " file.id = product_image.file_id";
}
