...
public class ReservationDaoSqls {
	...
	public static final String SELECT_RESERVATION_INFO_BY_EMAIL = "SELECT"
		+ " SUM(pd_price.price * rv_price.count) AS total_price,"
		...
		+ " INNER JOIN"
		+ " reservation_info_price AS rv_price"
		+ " ON"
		+ " reservation.id = rv_price.reservation_info_id"
		+ " INNER JOIN"
		+ " product_price AS pd_price"
		+ " ON"
		+ " pd_price.id = rv_price.product_price_id"
		+ " WHERE"
		+ " reservation.reservation_email = :email"
		+ " GROUP BY"
		+ " rv_price.reservation_info_id";

	public static final String SELECT_COUNT_RESERVATION_BY_EMAIL = "SELECT"
	...
	public static final String SELECT_COUNT_FINISH_RESERVATION_BY_EMAIL_AND_ID = "SELECT"
		+ " COUNT(reservation.id)"
		+ " FROM"
		+ " reservation_info AS reservation"
		+ " WHERE"
		...
		+ " reservation.id = :id"
		+ " AND"
		+ " reservation.cancel_flag = false"
		+ " AND"
		+ " reservation.reservation_date < NOW()";

	public static final String UPDATE_CANCEL_RESERVATION_BY_RESERVATION_ID = "UPDATE"
		+ " reservation_info"
		+ " SET"
		+ " cancel_flag = true"
		+ " WHERE"
	...
	public static final String INSERT_USER_COMMENT = "INSERT INTO"
	...
	public static final String INSERT_USER_COMMENT_IMAGE = "INSERT INTO"
	...
	public static final String SELECT_FILE_INFO_BY_COMMENT_IMAGE_ID = "SELECT"
		+ " file.file_name,"
		+ " file.save_file_name,"
		+ " file.content_type"
		+ " FROM"
