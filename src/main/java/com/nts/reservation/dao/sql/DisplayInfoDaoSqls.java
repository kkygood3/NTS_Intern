...
public class DisplayInfoDaoSqls {
	public static final String SELECT_DISPLAY_INFO_BY_ID = "SELECT"
		+ " display.product_id,"
	...
	public static final String SELECT_COMMENT_BY_DISPLAY_INFO_ID = "SELECT comment.comment,"
		...
		+ " ON"
		+ " reservation.id = comment.reservation_info_id"
		+ " WHERE"
		+ " reservation.display_info_id = :id";

	public static final String SELECT_COMMENT_AVG_SCORE_BY_DISPLAY_INFO_ID = "SELECT"
		+ " AVG(comment.score)"
		+ " FROM"
		+ " reservation_user_comment AS comment"
		+ " INNER JOIN"
	...
	public static final String SELECT_COMMENT_IMAGE_BY_ID = "SELECT"
		...
		+ " WHERE"
		+ " image.reservation_user_comment_id = :id"
		+ " ORDER BY"
		+ " file.create_date"
		+ " DESC";

	public static final String SELECT_DISPLAY_INFO_IMAGE_BY_ID = "SELECT"
		+ " file.content_type,"
		+ " file.create_date,"
		+ " file.delete_flag,"
		+ " file.modify_date,"
		...
		+ " WHERE"
		+ " image.display_info_id = :id";

	public static final String SELECT_PRODUCT_IMAGE_BY_ID = "SELECT"
		+ " file.content_type,"
		+ " file.create_date,"
		+ " file.delete_flag,"
	...
	public static final String SELECT_PRODUCT_PRICE_BY_ID = "SELECT"
		+ " price.create_date,"
		+ " price.modify_date,"
		+ " price.discount_rate,"
		+ " price.price,"
	...
	public static final String SELECT_MAIN_PRODUCT_IMAGE_BY_ID = "SELECT"
