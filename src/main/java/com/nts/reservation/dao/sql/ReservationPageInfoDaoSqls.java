...
public class ReservationPageInfoDaoSqls {
	...
	= "SELECT d.product_id, d.id AS display_info_id, p.description, d.place_name, d.opening_hours, pf.save_file_name AS main_image_name, adddate(now(), interval floor(rand()*6) day) AS reservation_date "
