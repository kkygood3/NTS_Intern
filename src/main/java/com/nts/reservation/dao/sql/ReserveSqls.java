...
public class ReserveSqls {
	public static final String SELECT_RESERVE_DISPLAY_INFO = 
		"SELECT display_info.id, product.description AS product_description, display_info.opening_hours, display_info.place_name, display_info.place_street, file_info.save_file_name AS product_image" + 
		" FROM display_info" + 
	...
	public static final String SELECT_RESERVE_PRICE = 
		"SELECT product_price.price, product_price.price_type_name, ROUND(product_price.discount_rate,0) AS discount_rate" + 
		" FROM display_info" + 
