...
public class ThumbnailInfoDaoSqls {
	...
	public static final String SELECT_BY_CATERORY_WITH_PAGING = "SELECT p.id AS id, p.description AS description, di.place_name AS place_name, p.content AS content "
