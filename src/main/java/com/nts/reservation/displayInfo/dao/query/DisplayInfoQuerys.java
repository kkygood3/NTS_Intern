...
public class DisplayInfoQuerys {
	...
	public static final String SELECT_DISPLAY_INFO_BY_RESERVATION_INFO_ID = " SELECT" +
		...
		" INNER JOIN display_info ON display_info.id = reservation_info.display_info_id" +
