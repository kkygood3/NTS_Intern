...
public class ProductQueries {
	public static final String SELECT_PROUDUCT_PAGE =
		...
		"		INNER JOIN " +
		"	display_info ON product.id = display_info.product_id " +
		"		INNER JOIN " +
		"	file_info ON product_image.file_id = file_info.id " +
	...
	public static final String SELECT_PROUDUCT_IMAGE =
		...
		"	product_image " +
		"		INNER JOIN " +
		"	file_info ON file_info.id = product_image.file_id " +
		"		INNER JOIN " +
		"	product ON product_image.product_id = product.id " +
		"		INNER JOIN " +
		"	display_info ON display_info.product_id = product.id " +
		"WHERE " +
		"	display_info.id = :displayInfoId;";

	public static final String SELECT_PROUDUCT_PRICE =
		"SELECT " +
		"	product_price.create_date AS create_date, " +
		...
		"	product_price.product_id AS product_id, " +
