 ...
 */
package com.nts.reservation.main.product.dao.query;

/**
 * @Author Duik Park, duik.park@nts-corp.com
 */
public class ProductDaoQuerys {
	public static final String SELECT_PRODUCT = "SELECT display_info.id AS display_info_id, display_info.place_name, product.content AS product_content, product.description AS product_description, product.id AS product_id, file_info.save_file_name AS product_image_url"
	...
	public static final String SELECT_PRODUCT_BY_CATEGORY = "SELECT COUNT(display_info.id) FROM product"
