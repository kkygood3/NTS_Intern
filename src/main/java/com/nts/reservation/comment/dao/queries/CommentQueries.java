...
public class CommentQueries {
	public static final String SELECT_COMMENT_IMAGES =
		...
		"	display_info " +
		"		INNER JOIN " +
		"	display_info_image ON display_info_image.display_info_id = display_info.id " +
		"		INNER JOIN " +
		"	file_info ON file_info.id = display_info_image.file_id " +
		"		INNER JOIN " +
		"	reservation_user_comment_image ON reservation_user_comment_image.file_id = file_info.id " +
		"WHERE " +
	...
	public static final String SELECT_COMMENT =
		...
		"	DATE_FORMAT(reservation_info.reservation_date, " +
