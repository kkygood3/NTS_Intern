...
public class Const {
	...
	public static final String PLACE_LOT = "placeLot";
	public static final String PLACE_STREET = "placeStreet";
	...
	public static final String RESERVATION_TEL = "reservationTel";
