...
public class DisplayInfoQueries {
	public static final String SELECT_DISPLAY_INFO =
		...
		"	display_info " +
		"		INNER JOIN " +
		"	product ON product.id = display_info.product_id " +
		"		INNER JOIN " +
	...
	public static final String SELECT_DISPLAY_INFO_IMAGE =
		...
		"	display_info_image " +
		"		INNER JOIN " +
		"	file_info ON display_info_image.file_id = file_info.id " +
		"		INNER JOIN " +
		"	display_info ON display_info.id = display_info_image.display_info_id " +
		"WHERE " +
		"	display_info.id = :displayInfoId;";

	public static final String SELECT_AVERAGE_SCORE =
		"SELECT " +
		"	ROUND(AVG(reservation_user_comment.score), 1) AS average_score " +
		"FROM " +
